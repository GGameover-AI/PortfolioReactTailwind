...
//import netcoreIcon from "../assets/SkillIcons/Netcore.svg";
  ...
  return (
    <Element name="Skills">
      <section className="flex flex-col justify-center items-center bg-gray-900 md:text-2xl text-white px-20 py-20">
        <h1 className="text-2xl md:text-5xl font-bold text-cyan-500 mb-8">
          Skills
        </h1>
        <div className="w-full md:w-auto place-items-center md:place-items-start grid grid-cols-1 md:grid-cols-2 bg-purple-500/10 shadow-lg shadow-pink-400/30 hover:shadow-xl hover:shadow-pink-400/50 rounded-2xl px-6 py-4 transition">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div>
              ...
              <div className="flex flex-wrap text-sm md:text-lg gap-4 mb-4">
                <img src={typescriptIcon} className=" w-8 h-8" />
                <p>Typescript</p>
              </div>
              <div className="flex flex-wrap text-sm md:text-lg gap-4 mb-4">
          ...
          <div>
            ...
            <div>
              <div className="flex flex-wrap text-sm md:text-lg gap-4 mb-4">
                <img src={angularIcon} className=" w-8 h-8" />
                <p>Angular</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex flex-wrap text-sm md:text-lg gap-4 mb-4">
                <img src={'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/.NET_Core_Logo.svg/512px-.NET_Core_Logo.svg.png?20210328084203'} className=" w-8 h-8" />
                <p>.Net Core</p>
              </div>
            </div>
          </div>
