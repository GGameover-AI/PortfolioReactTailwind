    ...
    <Element name="Hero">
      <section className="flex justify-center items-center px-12 pt-23 pb-5 bg-gradient-to-b from-black via-gray-950 to-gray-900">
        <div className="text-white">
          ...
          <button className="hidden sm:block px-6 pb-2 pt-1 bg-pink-500 hover:bg-pink-400  rounded-lg shadow-lg border-gray-700 text-white text-center">
        ...
        <div>
          <img src={avatar} className="mask-b-from-0% mask-b-to-98% brightness-110" />
        </div>
      </section>
    </Element>
  );
